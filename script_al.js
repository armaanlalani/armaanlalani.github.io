...
btn[2].onclick = function(){
  modal.style.display = "block";
  mod.innerHTML = "<h2 class='titles'>Praxis I and II</h2><p class='paragraph'>Two courses that provide a strong foundation on engineering design. The first course focuses mainly on the theory behind engineering design such as the process of diverging, converging, effective methods of idea generation, leadership styles, designing for various aspects of design, etc. Finished the course by designing a prototype of a wearable pencil case to assist students working while commuting to school.</p><p class='paragraph'>The second course focused on applying the concepts taught during the first course. I had the opportunity to work with three other students to design a mechanism or process to assist a local badminton club in collecting shuttlecocks after drills. This project consisted of applying various concepts taught earlier in the year through various brainstroming methods and utilizing comparison matrices and SCAMPER tools in order to converge towards an idea. We also had the opportunity to test our prototype at the badminton club to verify our solution and presented our idea at the end of the course.</p><img src='/Users/armaanlalani/Pictures/praxis2.jpg' width=250px><img src='/Users/armaanlalani/Pictures/praxis3.jpg' width=250px><img src='/Users/armaanlalani/Pictures/praxis1.png' width=250px>"
}
...
btn[4].onclick = function(){
  modal.style.display = "block";
  mod.innerHTML = "<h2 class='titles'>Structures and Materials</h2><p class='paragraph'>A very unique course that focused on a number of topics related to structures and civil engineering including stress-strain, the bending of beams, effective truss bridge design, flexural stresses, shear stress in beams, design of reinforced concrete, etc. The course also had two central projects including redesigning an existing bridge as a truss bridge using calculations and research and a hands on project where groups of students designed their own beam from matboard and glue. My team and I designed a beam that was able to withstand roughly 850 Newtons of force and found ourselves within the top 20% in terms of performance.</p><img src='/Users/armaanlalani/Pictures/civ1.jpg' width=250px><img src='/Users/armaanlalani/Pictures/civ2.jpg' width=250px><img src='/Users/armaanlalani/Pictures/civ3.jpg' width=250px>"
}

btn[5].onclick = function(){
  modal.style.display = "block";
  mod.innerHTML = "<h2 class='titles'>Fundamentals of Electric Circuits</h2><p class='paragraph'>An introduction to electrical circuits through a number of topics including nodal and mesh analysis, solving phasor circuits, power fcators, input signals using filters, inductance, etc. The course also had labs which allowed for testing various concepts that were taught during lectures.</p>"
}

btn[6].onclick = function(){
  modal.style.display = "block";
  mod.innerHTML = "<h2 class='titles'>Vector Calculus and Fluid Mechanics</h2><p class='paragraph'>The first half of this course dealt with a variety of concepts relating to multivariable calculus including tangent planes, integrals with parameters, change of variable with Jacobians, line integrals, Green's Theorem, divergence, curl, Stoke's Theorem, etc. The second half of the course was an application and extension of multivariable calculus through analysis of fluid motion. This half of the course focused on concepts such as body vs. surface forces, Newtonian fluids, hydrostatics, compressible vs. incompressible flow, open channel flow, differential analysis of fluid flow, etc.</p>"
}
...
btn[8].onclick = function(){
  modal.style.display = "block";
  mod.innerHTML = "<h2 class='titles'>Ordinary Differential Equations</h2><p class='paragraph'>A course with a focus on solving ordinary differential equations using a variety of methods depending on the question presented. Some concepts taught included method of integrating factors, the existence uniqueness theorem, systems of linear differential equations, stability of equilibrium points, fundamental matrices, nonhomogeneous linear systems, Laplace transforms, convolution integrals, etc. The course also had a strong focus on applying these concepts using MATLAB which can be found by <a href='https://github.com/armaanlalani/Ordinary-Differential-Equations_MATLAB' target='_blank'>clicking on this link</a>.</p>"
}

btn[9].onclick = function(){
  modal.style.display = "block";
  mod.innerHTML = "<h2 class='titles'>Probability and Statistics</h2><p class='paragraph'>An introduction to various concepts relating to probability and statistics. Course concepts include conditional probability, Baye's Rule, probability functions, cumulative distribution functions, joint probability distribution, covariance, binomia; distribution, hypergeometric distribution, normal distribution, exponential distribution, transformation of variables, moment generating functions, t-distribution, interval estimates, Cramer Rao lower bounds, one and two sample tests of hypotheses, etc.</p>"
}

btn[10].onclick = function(){
  modal.style.display = "block";
  mod.innerHTML = "<h2 class='titles'>Praxis III</h2><p class='paragraph'>Praxis III is probably one of the most important and interesting courses I have taken so far in my undergraduate degree. The basis of the course involved designing an autonomous mechanism that was able to deliver electric chargers to cars located in a parking lot. This task was to be completed in teams of three and could be tackled in any which way as long as a number of restraints were followed. Prior to engaging in the project, my team and I had to complete a number of workshops on topics in rover fabrication, digital modelling, circuits and microcontrollers, motors and drivers, and interfacing. <a href='#projects'>Visit the projects section of the page</a> to learn more about my team's solution or <a href='/Users/armaanlalani/Pictures/praxisIII.pdf' download target='_blank'>download the challenge rules</a> to learn more.</p><p class='paragraph'>Due to the COVID-19 outbreak, this project was not completed due to lack of access to building and testing facilities. As a result, I completed an individual project around the concept of PID control using MATLAB. PID control is an essential concept relating to robotics to ensure any robot with wheels is able to travel as straight as possible when required. I was able to successfully implement PID control to the motion of simulated robot while also incorporating compass control which had a very significant impact on the robot's motion. Run the main_script.m file accessible through <a href='https://github.com/armaanlalani/PID_Controller' target = '_blank'>this link</a> to view the robot simulation and <a href='/Users/armaanlalani/Documents/Engineering Science Year 2/Winter Term/Praxis III/3.1_Armaan Lalani_Closed-Loop Controller.pdf' download target='_blank'>click on this link</a> to view my report which explains the various decisions I made.</p>"
}

btn[11].onclick = function(){
  modal.style.display = "block";
  mod.innerHTML = "<h2 class='titles'>Quantum and Thermal Physics</h2><p class='paragraph'>The first half of this course dealt with quantum physics. Course topics included quantum harmonic oscillators, solving Schrodinger's Equation, particles in a box, transmission and reflection, potential steps and wells, electron spin, etc. The second half of the course dealt with topics relating to thermal physics inluding compression and expansion, heat capacity, microstates and macrostates of molecules, statistical mechanics, etc. I also had the opportunity to engage in a number of labs including the Millikan oil drop experiment, wave phenomena experiments, etc.</p>"
}
