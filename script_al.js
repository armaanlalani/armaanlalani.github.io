...
btn[4].onclick = function(){
  modal.style.display = "block";
  mod.innerHTML = "<h2 class='titles'>Structures and Materials</h2><p class='paragraph'>A very unique course that focused on a number of topics related to structures and civil engineering including stress-strain, the bending of beams, effective truss bridge design, flexural stresses, shear stress in beams, design of reinforced concrete, etc. The course also had two central projects including redesigning an existing bridge as a truss bridge using calculations and research and a hands on project where groups of students designed their own beam from matboard and glue. My team and I designed a beam that was able to withstand roughly 850 Newtons of force and found ourselves within the top 20% in terms of performance.</p><img src='civ1.jpg' width=250px><img src='civ2.jpg' width=250px><img src='civ3.jpg' width=250px>"
}
